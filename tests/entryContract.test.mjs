...
test('local entry guard runs before dynamic app import', () => {
  ...
  const load = local.indexOf("import('./js/app.js?v=1.6.0-calendar-wage-hotfix-1')");
...
test('legacy 1.6.0 asset query is fully replaced by the calendar wage hotfix token', () => {
  ...
  assert.match(local, /1\.6\.0-calendar-wage-hotfix-1/);
});
