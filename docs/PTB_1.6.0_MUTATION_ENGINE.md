...
asset_version: 1.6.0-batch-search-style-hotfix-10
...
部署測試環境時設定 `PTB_STATIC_ASSET_VERSION=1.6.0-batch-search-style-hotfix-10`。真實 harness 另需匿名測試 Sheet 副本與 `PTB_TEST_MODE=enabled`。
