...
asset_version: 1.6.0-salary-summary-cards-hotfix-12
...
部署測試環境時設定 `PTB_STATIC_ASSET_VERSION=1.6.0-salary-summary-cards-hotfix-12`。真實 harness 另需匿名測試 Sheet 副本與 `PTB_TEST_MODE=enabled`。
