...
with sync_playwright() as p:
    ...
    page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-hour-filter-holiday-salary-layout-hotfix-9');await app.bootstrap();
    }""")
    ...
    failure_page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-hour-filter-holiday-salary-layout-hotfix-9');
      await app.bootstrap();
    }""")
