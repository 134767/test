...
with sync_playwright() as p:
    ...
    page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-salary-summary-cards-hotfix-12');await app.bootstrap();
    }""")
    ...
    failure_page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-salary-summary-cards-hotfix-12');
      await app.bootstrap();
    }""")
