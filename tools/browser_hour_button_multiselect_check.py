...
with sync_playwright() as p:
    ...
    page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-hour-budget-batch-hotfix-7');await app.bootstrap();
    }""")
    ...
    failure_page.evaluate("""async () => {
      ...
      const app=await import('/js/app.js?v=1.6.0-hour-budget-batch-hotfix-7');
      await app.bootstrap();
    }""")
